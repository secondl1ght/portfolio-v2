...
<div class="mt-10 block justify-between lg:flex">
	<div class="w-full md:w-2/3">
		...
		{/if}
		<p
			class="ibm w-full text-secondary md:text-lg lg:w-3/4 lg:text-xl {title === 'btc map'
				? 'mt-5'
				: 'mt-8'} mb-10 !leading-normal"
		>
			{description}
		</p>
		<h4 class="jakarta mb-5 text-lg text-white md:text-xl lg:text-2xl">contribution</h4>
		<p class="ibm w-full !leading-normal text-secondary md:text-lg lg:w-3/4 lg:text-xl">
			{#if title === 'btc map'}
