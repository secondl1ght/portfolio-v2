...
<div class="relative mx-auto mt-40 w-3/4 lg:w-2/3 xl:w-7/12 2xl:w-1/2">
	...
	<h2 class="jakarta mb-16 text-4xl text-white md:text-5xl lg:text-6xl">contributions</h2>
	<!--
  <div
